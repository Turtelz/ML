...
while True:
    ...
    if keyboard.is_pressed('q'):
      ...
      break
env.close()
model.save("C:/Users/sheld/Desktop/Desktop/Productive_stuff/Notes/Turtelz/Code/Aplications of Notes/ML/models/testingCustomGymEnv")